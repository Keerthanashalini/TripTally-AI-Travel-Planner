  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10">
      <h2 className="font-bold text-3xl">
        Create Your Dream Vacation Plan 🌍✨
      </h2>
      <p className="mt-3 text-gray-500 text-xl">
        Tell us a bit about your preferences, and let our AI craft the perfect
          ...
          {step === fields.length && (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-6">
                Everything's set! Click the button below to create your dream
                trip 🚀
              </h3>
              <Button
                type="submit"
